...
public class InitialCrosswords {
	public static pass getCrossword1() {
		...
		return new pass("An Example Crossword", 11, acrossClues, downClues);
	}

	public static pass getCrossword2() {
		ArrayList<Clue> acrossClues = new ArrayList<Clue>();
		ArrayList<Clue> downClues = new ArrayList<Clue>();
		...
		return new pass("Guardian 13,019", 13, acrossClues, downClues);
	}
